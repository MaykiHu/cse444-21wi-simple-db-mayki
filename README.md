...
The optimizer will be invoked from `simpledb/Parser.java`. You may wish to review the [lab 2 parser exercise](https://gitlab.cs.washington.edu/cse444-21wi/simple-db/blob/lab2/README.md) before starting this lab. Briefly, if you have a catalog file `catalog.txt` describing your tables, you can run the parser by typing:
...
To git@gitlab.com:cse444-21wi/hsimple-db-pirateninja.git
 * [new tag]         lab5 -> lab5
```
